...
namespace PizzaRestaurantDemo.Persistence.Migrations
{
    ...
    [Migration("20250415212722_updatefilter")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderPizza", b =>
                {
                    b.Property<int>("PizzaOrdersId")
                        .HasColumnType("int");

                    b.Property<int>("PizzasId")
                        .HasColumnType("int");

                    b.HasKey("PizzaOrdersId", "PizzasId");

                    b.HasIndex("PizzasId");

                    b.ToTable("OrderPizza", "dbo");
                });
            ...
            modelBuilder.Entity("OrderPizza", b =>
                {
                    b.HasOne("PizzaRestaurantDemo.Domain.Models.Order", null)
                        .WithMany()
                        .HasForeignKey("PizzaOrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaRestaurantDemo.Domain.Models.Pizza", null)
                        .WithMany()
